            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="deliveryads"
                        to="/supportServices/deliveryads"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="viewStatuses"
                        to="/dashboardservices/viewStatuses"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: 'delivery', 
                description: 'deliveryad을 관리하는 화면입니다.', 
                key: 'deliveryads', 
                route: '/supportServices/deliveryads',
                ImageUrl: '',
            },
            { 
                title: 'inventory', 
            ...
            { 
                title: 'ViewStatus', 
                description: 'view status을 관리하는 화면입니다.', 
                key: 'viewStatuses', 
                route: '/dashboardservices/viewStatuses',
                ImageUrl: '',
            },
